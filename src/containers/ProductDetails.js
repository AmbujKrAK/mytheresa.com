          ...
          <div className="ui two column stackable center aligned grid">
            ...
            <div className="middle aligned row">
              ...
              <div className="column rp">
                ...
                <br /><button className="addbtn" onClick={() => {
                  addtocart()
                ...
                <Info />
                <a style={{ display: "block", color: "gray", margin: "8px", fontSize: "18px", cursor: "pointer" }}>More questions about this item?</a>
                <a style={{ display: "block", color: "gray", margin: "8px", fontSize: "18px", cursor: "pointer" }}>See more {name}</a>
                <a style={{ display: "block", color: "gray", margin: "8px", fontSize: "18px", cursor: "pointer" }}>See more Clothing by {brandName}</a>
                <a style={{ display: "block", color: "gray", margin: "8px", fontSize: "18px", cursor: "pointer" }}>See more Clothing</a>
